...
public class VistaConsola {
    ...
    public void evaluarSeleccion() throws ExcepcionArchivo{
    ...
    public void ejecutarMenu() throws ExcepcionArchivo{
    ...
    public void run() throws ExcepcionArchivo{
        this.ejecutarMenu();
    }
    
    public void leerPublicaciones() throws ExcepcionArchivo{

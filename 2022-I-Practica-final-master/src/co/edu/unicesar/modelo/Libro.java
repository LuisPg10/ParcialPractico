...
public class Libro extends Publicacion{
    ...
    public String getDataStringFormat() {
        return "L;" + this.isbn + ";" + this.titulo + ";" + this.autor + ";" + this.anio + ";" + this.costo + ";" + this.nPaginas + ";" + this.edicion;
    }
    ...
    public String getStringFormat() {
        ...
        String cadena = String.format("%-10s %-10s %-30s %-30s %-10d %-10d %-10s %-10s %-10s", 
                "Libro", this.isbn, this.titulo, this.autor, this.nPaginas, this.edicion, "","","");
        return cadena;
    }
}

...
public class AudioLibro extends Publicacion {
    ...
    public String getDataStringFormat() {
        return "A;" + this.isbn + ";" + this.titulo + ";" + this.autor + ";" + this.anio + ";" + this.costo + ";" + this.formato + ";" + this.duracion + ";" + this.peso;
    }
    ...
    public String getStringFormat() {
        ...
        String cadena = String.format("%-10s %-10s %-30s %-30s %-10s %-10s %-10.2f %-10.2f %-10s", 
                "Audio Libro", this.isbn, this.titulo, this.autor, "", "", this.peso,this.duracion,this.formato);
        return cadena;
    }
}
